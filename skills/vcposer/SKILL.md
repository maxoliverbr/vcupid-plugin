...
```markdown
# Poser Check: [Fund Name]
_For: [Startup Name] | Generated: [date] | Stage: [stage] | Ask: $[amount]_

---

## Poser Score: XX/100 — [VERDICT]
...
### 1. Fund Vitality
**Signal:** 🟢/🟡/🔴
**Finding:** [1–2 sentences — last deal date, deal frequency]
**Evidence:** [source]

### 2. Fund Health
**Signal:** 🟢/🟡/🔴
**Finding:** [fund close date, current deployment status, partner continuity]
**Evidence:** [source]

### 3. Thesis Authenticity
**Signal:** 🟢/🟡/🔴
**Finding:** [portfolio sector breakdown vs. stated thesis]
**Evidence:** [source]

### 4. Lead vs. Follow
**Signal:** 🟢/🟡/🔴
**Finding:** [evidence of deal leadership or absence]
**Evidence:** [source]

### 5. Stage Honesty
**Signal:** 🟢/🟡/🔴
**Finding:** [stated stage vs. actual entry stage of last 5–10 deals]
**Evidence:** [source]

### 6. Check Size Reality
**Signal:** 🟢/🟡/🔴
**Finding:** [stated range vs. observed deal sizes]
**Evidence:** [source]

### 7. Signal-to-Check Ratio
**Signal:** 🟢/🟡/🔴
**Finding:** [content/conference volume vs. new deal count last 12 months]
**Evidence:** [source]

### 8. Founder Sentiment
**Signal:** 🟢/🟡/🔴
**Finding:** [summary of public feedback patterns]
**Evidence:** [source]

---

## Verdict Rationale
[2–3 sentences synthesizing the checks that most influenced the score — name the specific findings]

## Recommended Action
[Exactly what to do next — with the relevant skill command to run]
```
